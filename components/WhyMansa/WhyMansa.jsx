        ...
        <div className="rounded-2xl bg-[#EFEFEF] text-[#1B1D29]">
          <div className="px-12 py-8">
            ...
            <p className="text-base leading-6 opacity-60 pb-4">
              ...
              resources, fierce market competition, and uncertainty are just a
              few of the challenges they face. In this context, Mansa Africa
              emerges as a beacon of support for SMEs, offering a gateway to
