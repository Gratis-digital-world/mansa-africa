    ...
    <div className="text-[#18181B] bg-white text-[1.1rem] px-4 lg:px-12 pb-12">
      ...
      <div className="rounded-2xl bg-[#EFEFEF] text-[#1B1D29]">
        <div className="px-4 lg:px-12 py-4 lg:py-8">
          <p className="pb-2 text-lg font-semibold">Why Mansa?</p>
          <p className="text-base leading-6 opacity-60 pb-4">
            In the heart of the African business landscape, small and
            medium-sized enterprises (SMEs) often find themselves navigating a
            complex and competitive environment. Limited access to financial
            resources, fierce market competition, and uncertainty are just a few
            of the challenges they face. In this context, Mansa Africa emerges
            as a beacon of support for SMEs, offering a gateway to growth and
